public class CatHouse
{
    ...
    public void rollCall() {
        // If both cats have the same age and name
        ...
        // If both cats have the same age
        else if (cat1.getAge() == cat2.getAge())
        {
            // If cat1 is alphabetically first
        ...
        // If cats have different age
        // Introduce older one first
        else
        {
